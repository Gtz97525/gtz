...
import javax.swing.*;
/**
 *	Title: makeSureDrink.java
 *	Description: This class is make users make sure whether they want to order that drink.
 *	@author  Qiaokun Wen
 *	@version 1.0
 */
public class makeSureDrink extends JFrame implements ActionListener {
	...
	public String[] s;
	public int num;
	public String name,drinkPrice;
	/**
	 * similar to makeSureFish,use name and add two button.
	 */
	public makeSureDrink(String name){
		this.name=name;
		frame8=new JFrame();
		panel1=new JPanel();
		panel2=new JPanel();
	...
	/**
	 * this part is to put the data into an array, using it to achieve amount-1.
	 */
	public void actionPerformed(ActionEvent event){
		...
		if (event.getSource().equals(button1)){
			...
			try {
				...
				fileReader = new FileReader("..\\..\\Files\\DrinkDishes.txt");
			...
			try {
				writer = new FileWriter("..\\..\\Files\\DrinkDishes.txt");
	...
	/**
	 * this part is to write the name wich is ordered into a new file ordered.txt which is created.
	 */
	 ...
	 */
	public String settwo(String drinkPrice){
	     try{
	      String data=drinkPrice;
	      File file =new File("ordered.txt");
	      file.createNewFile();
	      FileWriter fileWritter = new FileWriter(file.getName(),true);
	             BufferedWriter bufferWritter = new BufferedWriter(fileWritter);
