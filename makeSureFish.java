...
import javax.swing.*;
/**
 *	Title: makeSureFish.java
 *	Description: This class is make users make sure whether they want to order that fish.
 *	@author  Qiaokun Wen
 *	@version 1.0
 */
public class makeSureFish extends JFrame implements ActionListener {
	...
	public String[] s;
	public int num;
	public String name,fishPrice;
	
	/**
	 * use name and add two button ,use the method to write.
	 */
	public makeSureFish(String name){
		this.name=name;
		frame8=new JFrame();
		panel1=new JPanel();
		panel2=new JPanel();
	...
	public void actionPerformed(ActionEvent event){
		...
		if (event.getSource().equals(button1)){
			...
			try {
				...
				fileReader = new FileReader("..\\..\\Files\\FishDishes.txt");
			...
			try {
				writer = new FileWriter("..\\..\\Files\\FishDishes.txt");
	 ...
	 */
	public String settwo(String fishPrice){
	     try{
	      String data = fishPrice;
	      File file =new File("ordered.txt");
	      file.createNewFile();
	      FileWriter fileWritter = new FileWriter(file.getName(),true);
	             BufferedWriter bufferWritter = new BufferedWriter(fileWritter);
