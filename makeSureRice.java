...
import javax.swing.*;
/**
 *	Title: makeSureRice.java
 *	Description: This class is make users make sure whether they want to order that rice.
 *	@author  Qiaokun Wen
 *	@version 1.0
 */
public class makeSureRice extends JFrame implements ActionListener {
	...
	public String[] s;
	public int num;
	public String name,ricePrice;

	/**
	 * use name and add two button ,use the method to write.
	 */
	public makeSureRice(String name){
		this.name=name;
		frame8=new JFrame();
		panel1=new JPanel();
		panel2=new JPanel();
	...
	public void actionPerformed(ActionEvent event){
		...
		if (event.getSource().equals(button1)){
			...
			try {
				...
				fileReader = new FileReader("..\\..\\Files\\RiceDishes.txt");
			...
			try {
				writer = new FileWriter("..\\..\\Files\\RiceDishes.txt");
	 ...
	 */
	public String settwo(String ricePrice){
	     try{
	      String data = ricePrice;
	      File file =new File("ordered.txt");
	      file.createNewFile();
	      FileWriter fileWritter = new FileWriter(file.getName(),true);
	             BufferedWriter bufferWritter = new BufferedWriter(fileWritter);
