...
/**
 *	Title: rice.java
 *	Description: This class is 6 types of rice and users can select a dish.
 *	@author  Qiaokun Wen
 *	@version 1.0
 */
public class rice extends JFrame implements ActionListener {
	...
	public rice(int n){
		...
		l1=new JLabel("1. yángzhōu chǎofàn   ￥23",JLabel.CENTER);//文字居中
		l2=new JLabel("2. hóngcháng chǎofàn   ￥32",JLabel.CENTER);
		l3=new JLabel("3. huǒtuǐ chǎofàn   ￥26",JLabel.CENTER);
		l4=new JLabel("4. jiàngyóu chǎofàn   ￥32",JLabel.CENTER);
		l5=new JLabel("5. gāli chǎofàn   ￥21",JLabel.CENTER);
		l6=new JLabel("6. bái mǐfàn   ￥3",JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent event){
		...
		if(number2.equals("1")){
			name="yángzhōu chǎofàn";
			new makeSureRice("yángzhōu chǎofàn");
		}
		else if(number2.equals("2")){
			name="hóngcháng chǎofàn";
			new makeSureRice("hóngcháng chǎofàn");
		}
		else if(number2.equals("3")){
			name="huǒtuǐ chǎofà";
			new makeSureRice("huǒtuǐ chǎofà");
		}
		else if(number2.equals("4")){
			name="jiàngyóu chǎofàn";
			new makeSureRice("jiàngyóu chǎofàn");
		}
		else if(number2.equals("5")){
			name="gāli chǎofàn";
			new makeSureRice("gāli chǎofàn");
		}
		else if(number2.equals("6")){
			name="bái mǐfàn";
			new makeSureRice("bái mǐfàn");
		}
		else{
			new rice(3);
		}
