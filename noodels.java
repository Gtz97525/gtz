...
public class noodels extends JFrame implements ActionListener {
	...
	public noodels(int n){
		...
		l1=new JLabel("1. chǎo miàn   ￥22",JLabel.CENTER);//文字居中
		l2=new JLabel("2. tāng miàn   ￥18",JLabel.CENTER);
		l3=new JLabel("3. niúroù miàn   ￥15",JLabel.CENTER);
		l4=new JLabel("4. yóupō miàn   ￥25",JLabel.CENTER);
		l5=new JLabel("5. lěng miàn   ￥15",JLabel.CENTER);
		l6=new JLabel("6. jīsī bànmiàn   ￥19",JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent event){
		...
		if(number2.equals("1")){
			name="chǎo miàn";
			new makeSureNoodels("chǎo miàn");
		}
		else if(number2.equals("2")){
			name="tāng miàn";
			new makeSureNoodels("tāng miàn");
		}
		else if(number2.equals("3")){
			name="niúroù miàn";
			new makeSureNoodels("niúroù miàn");
		}
		else if(number2.equals("4")){
			name="yóupō miàn";
			new makeSureNoodels("yóupō miàn");
		}
		else if(number2.equals("5")){
			name="lěng miàn";
			new makeSureNoodels("lěng miàn");
		}
		else if(number2.equals("6")){
			name="jīsī bànmiàn";
			new makeSureNoodels("jīsī bànmiàn");
		}
		else{
			new noodels(3);
		}
