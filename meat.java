...
public class meat extends JFrame implements ActionListener {
	...
	public meat(int n){
		...
		l1=new JLabel("1.gōngbàojīdīng   ￥25",JLabel.CENTER);//文字居中
		l2=new JLabel("2.suàntái ròusī   ￥32",JLabel.CENTER);
		l3=new JLabel("3.huíguōròu   ￥45",JLabel.CENTER);
		l4=new JLabel("4.guōbāoròu   ￥42",JLabel.CENTER);
		l5=new JLabel("5.làzǐjī   ￥34",JLabel.CENTER);
		l6=new JLabel("hóngshāo páigǔ  ￥24",JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent event){
		...
		if(number2.equals("1")){
			name="gōngbàojīdīng";
			new makeSureMeat("gōngbàojīdīng");
		}
		else if(number2.equals("2")){
			name="suàntái ròusī";
			new makeSureMeat("suàntái ròusī");
		}
		else if(number2.equals("3")){
			name="huíguōròu";
			new makeSureMeat("huíguōròu");
		}
		else if(number2.equals("4")){
			name="guōbāoròu";
			new makeSureMeat("guōbāoròu");
		}
		else if(number2.equals("5")){
			name="làzǐjī";
			new makeSureMeat("làzǐjī");
		}
		else if(number2.equals("6")){
			name="hóngshāo páigǔ";
			new makeSureMeat("hóngshāo páigǔ");
		}
		else{
			new meat(3);
		}
